...
export default function StudentLeaveScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: bgColor }]}>
      <ScrollView onScroll={onTabBarScroll} scrollEventThrottle={16} contentContainerStyle={{ paddingBottom: bottomPadding }}>
      ...
      <Modal visible={showForm} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: isDark ? Colors.card.dark : THEME.white, paddingBottom: Math.max(40, bottomPadding) }]}> 
