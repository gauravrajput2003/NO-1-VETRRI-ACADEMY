// ─── API Configuration
const PROD_API_ORIGIN = 'https://no-1-vetrri-academy.onrender.com'; // Changed from render.com to test locally
...
export const getDiceBearUrl = (userId) =>
  `https://api.dicebear.com/7.x/avataaars/png?seed=${userId}&backgroundColor=b6e3f4,c0aede,d1d4f9&radius=50`;
