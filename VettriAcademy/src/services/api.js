...
export const getStudentFeeDirectoryAPI = (params) =>
  api.get('/admin/student-fees', { params });

export const getStudentFeeHistoryAPI = (studentId) =>
  api.get(`/admin/fees/history/${studentId}`);
